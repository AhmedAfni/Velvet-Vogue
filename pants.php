  ...
  <div class="container">
    <header class="d-flex justify-content-center py-3">
      <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a href="pants.php" class="nav-link active aria-current="page">PANTS</a></li>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column align-items-center">
                <img src="assets/pant1.svg" class="img-fluid mb-3" alt="Stretch Casual Denim Pants." style="max-height: 200px;">
...
<div class="modal fade" id="productModal2" tabindex="-1" aria-labelledby="productModalLabel2" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column align-items-center">
                <img src="assets/pant2.svg" class="img-fluid mb-3" alt="Stretch Casual Denim Pants." style="max-height: 200px;">
                <h6 class="text-center mb-3">Stretch Casual Denim Pants.</h6>
                <div class="mb-4 w-100">
                    <label class="form-label">Select Size</label>
                    <div class="d-flex justify-content-around">
