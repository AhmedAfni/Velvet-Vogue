...
<div class="album py-5 bg-light">
    <div class="container">
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4"> 
            ...
            <div class="col">
                <div class="card shadow-sm product-card">
                    <img src="assets/tshirt4.svg" class="card-img-top" alt="Tshirt Image">
                    <div class="card-body">
                        <p class="card-text">Men Solid Round Neck T-Shirt.</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
             ...
             <div class="col">
                <div class="card shadow-sm product-card">
                    <img src="assets/tshirt5.svg" class="card-img-top" alt="Tshirt Image">
                    <div class="card-body">
                        <p class="card-text">Men Solid Round Neck T-Shirt.</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
            ...
            <div class="col">
                <div class="card shadow-sm product-card">
                    <img src="assets/tshirt6.svg" class="card-img-top" alt="Tshirt Image">
                    <div class="card-body">
                        <p class="card-text">Men Solid Round Neck T-Shirt.</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
...
<div class="modal fade" id="productModal4" tabindex="-1" aria-labelledby="productModalLabel4" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column align-items-center">
                <img src="assets/tshirt4.svg" class="img-fluid mb-3" alt="Men Solid Round Neck T-Shirt." style="max-height: 200px;">
                <h6 class="text-center mb-3">Men Solid Round Neck T-Shirt.</h6>
                <div class="mb-4 w-100">
                    <label class="form-label">Select Size</label>
                    <div class="d-flex justify-content-around">
...
<div class="modal fade" id="productModal5" tabindex="-1" aria-labelledby="productModalLabel5" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column align-items-center">
                <img src="assets/tshirt5.svg" class="img-fluid mb-3" alt="Men Solid Round Neck T-Shirt." style="max-height: 200px;">
                <h6 class="text-center mb-3">Men Solid Round Neck T-Shirt.</h6>
                <div class="mb-4 w-100">
                    <label class="form-label">Select Size</label>
                    <div class="d-flex justify-content-around">
...
<div class="modal fade" id="productModal6" tabindex="-1" aria-labelledby="productModalLabel6" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column align-items-center">
                <img src="assets/tshirt6.svg" class="img-fluid mb-3" alt="Men Solid Round Neck T-Shirt." style="max-height: 200px;">
                <h6 class="text-center mb-3">Men Solid Round Neck T-Shirt.</h6>
                <div class="mb-4 w-100">
                    <label class="form-label">Select Size</label>
                    <div class="d-flex justify-content-around">
