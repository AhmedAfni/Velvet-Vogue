        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4"> <!-- Increased gap between products -->
            ...
            <div class="col">
                <div class="card shadow-sm product-card">
                    <img src="assets/shorts1.svg" class="card-img-top" alt="Tshirt Image">
                    <div class="card-body">
                        <p class="card-text">Men Drawstring Waist Shorts</p>
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <small class="text-muted">LKR. 1,490.00</small>
                        </div>
                    </div>
                </div>
            </div>
             ...
             <div class="col">
                <div class="card shadow-sm product-card">
                    <img src="assets/shorts2.svg" class="card-img-top" alt="Tshirt Image">
                    <div class="card-body">
                        <p class="card-text">Men Drawstring Waist Shorts</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
              ...
              <div class="col">
                <div class="card shadow-sm product-card">
                    <img src="assets/shorts3.svg" class="card-img-top" alt="Tshirt Image">
                    <div class="card-body">
                        <p class="card-text">Men Drawstring Waist Shorts</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
            ...
            <div class="col">
                <div class="card shadow-sm product-card">
                    <img src="assets/shorts4.svg" class="card-img-top" alt="Tshirt Image">
                    <div class="card-body">
                        <p class="card-text">Men Drawstring Waist Shorts</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
             ...
             <div class="col">
                <div class="card shadow-sm product-card">
                    <img src="assets/shorts5.svg" class="card-img-top" alt="Tshirt Image">
                    <div class="card-body">
                        <p class="card-text">Men Drawstring Waist Shorts</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
            ...
            <div class="col">
                <div class="card shadow-sm product-card">
                    <img src="assets/shorts6.svg" class="card-img-top" alt="Tshirt Image">
                    <div class="card-body">
                        <p class="card-text">Men Drawstring Waist Shorts</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column align-items-center">
                <img src="assets/shorts1.svg" class="img-fluid mb-3" alt="Stretch Casual Denim Pants." style="max-height: 200px;">
                <h6 class="text-center mb-3">Men Drawstring Waist Shorts</h6>
...
<div class="modal fade" id="productModal2" tabindex="-1" aria-labelledby="productModalLabel2" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column align-items-center">
                <img src="assets/shorts2.svg" class="img-fluid mb-3" alt="Stretch Casual Denim Pants." style="max-height: 200px;">
                <h6 class="text-center mb-3">Men Drawstring Waist Shorts</h6>
                <div class="mb-4 w-100">
                    <label class="form-label">Select Size</label>
                    <div class="d-flex justify-content-around">
...
<div class="modal fade" id="productModal3" tabindex="-1" aria-labelledby="productModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column align-items-center">
                <img src="assets/shorts3.svg" class="img-fluid mb-3" alt="Stretch Casual Denim Pants." style="max-height: 200px;">
                <h6 class="text-center mb-3">Men Drawstring Waist Shorts</h6>
                <div class="mb-4 w-100">
                    <label class="form-label">Select Size</label>
                    <div class="d-flex justify-content-around">
...
<div class="modal fade" id="productModal4" tabindex="-1" aria-labelledby="productModalLabel4" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column align-items-center">
                <img src="assets/shorts4.svg" class="img-fluid mb-3" alt="Stretch Casual Denim Pants." style="max-height: 200px;">
                <h6 class="text-center mb-3">Men Drawstring Waist Shorts</h6>
                <div class="mb-4 w-100">
                    <label class="form-label">Select Size</label>
                    <div class="d-flex justify-content-around">
...
<div class="modal fade" id="productModal5" tabindex="-1" aria-labelledby="productModalLabel5" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column align-items-center">
                <img src="assets/shorts5.svg" class="img-fluid mb-3" alt="Stretch Casual Denim Pants." style="max-height: 200px;">
                <h6 class="text-center mb-3">Men Drawstring Waist Shorts</h6>
                <div class="mb-4 w-100">
                    <label class="form-label">Select Size</label>
                    <div class="d-flex justify-content-around">
...
<div class="modal fade" id="productModal6" tabindex="-1" aria-labelledby="productModalLabel6" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column align-items-center">
                <img src="assets/shorts6.svg" class="img-fluid mb-3" alt="Stretch Casual Denim Pants." style="max-height: 200px;">
                <h6 class="text-center mb-3">Men Drawstring Waist Shorts</h6>
                <div class="mb-4 w-100">
                    <label class="form-label">Select Size</label>
                    <div class="d-flex justify-content-around">
